...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { S2 }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
#set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { debug }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
...
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { debug }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led17_b
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { B2 }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { B1 }]; #IO_L10N_T1_D15_14 Sch=btnr
